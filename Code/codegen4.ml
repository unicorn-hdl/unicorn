...
let rec expr builder ((_,e): sbinExpr) = match e with
    SBuslit b -> ignore(print_endline "in here"); L.const_int i32_t (int_of_string ("0b" ^ b))
    | SCall ("print", [e]) -> ignore(print_endline "heer") ;
	    L.build_call printf_func [| int_format_str ; (expr builder e) |] "printf" builder
    | _ -> ignore (print_endline "thesessses"); L.const_int i32_t (0)

let addInlist inlist = ignore(print_string "heya buddy"); expr builder (1, SCall ("print", [(1, SBuslit "101")] ))
